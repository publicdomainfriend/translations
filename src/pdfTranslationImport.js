/* This script imports the translation script from the local output folder, where it is expected to exist, so it can be used in your Twine Sugarcube project.

Recommended for use with Tweego.
*/
...
importScripts("pdfTranslationScript.js")
	.then(() => {
